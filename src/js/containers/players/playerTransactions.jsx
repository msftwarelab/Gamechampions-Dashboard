...
import PlayerTransactionsTable from "~components/custom/players/playerTransactionsTable";
      ...
      <Modal onClick={() => history.push(`/${selectedLanguage}/all-players`)}>
        ...
        >
          <FlexBox flexDirection={{ md: "row-reverse", base: "column" }}>
            <DynamicForm
              formFields={getTransactionsFormFields({
...
const mapDispatchToProps = dispatch => ({
  onLoadTransactions: data => dispatch(getPlayerTransactions(data)),
