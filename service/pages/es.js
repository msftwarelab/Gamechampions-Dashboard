...
export const esPages = [
  ...
  },
  {
    ...
    title: "Recent Players",
    summary: "",
    url: "/es/game-lobby/:gameId/recentplayers",
    isHidden: true
  },
  {
    meta: {
    ...
    title: "Matchmaking",
    summary: "",
    url: "/es/game-lobby/:gameId/matchmaking",
    isHidden: true
  },
  {
    meta: {
    ...
    title: "Leaderboards",
    summary: "",
    url: "/es/game-lobby/:gameId/leaderboards",
    isHidden: true
  },
  {
    meta: {
    ...
    title: "Leaderboards Details",
    summary: "",
    url: "/es/game-lobby/:gameId/leaderboards/:playerId/:playerAction?",
    isHidden: true
  },
  {
    meta: {
  ...
  },
  {
    ...
    title: "Rules",
    summary: "",
    url: "/es/game-lobby/:gameId/rules",
    isHidden: true
  },
  {
    meta: {
  ...
  },
  {
    ...
    title: "Player Details",
    summary: "",
    url: "/es/player-details/:playerId",
    isHidden: true
  },
  {
    meta: {
    ...
    title: "Match Details",
    summary: "",
    url: "/es/player-details/:playerId/matches/:matchId/:matchAction?",
    isHidden: true
  },
  {
    meta: {
    ...
    title: "Transaction Details",
    summary: "",
    url: "/es/transaction-details/:transactionId/:transactionAction?",
    isHidden: true
  },
  {
    meta: {
    ...
    title: "Create Challenge",
    summary: "",
    url: "/es/create-challenge/:gameId?",
    isHidden: true
  },
  {
    meta: {
    ...
    title: "Game details",
    summary: "",
    url: "/es/admin-games/:gameId/:gameAction?",
    isHidden: true
  },
  {
    meta: {
    ...
    title: "Send Challenge Request",
    summary: "",
    url: "/es/player-details/:playerId/send-challenge/:gameId?",
    isHidden: true
  },
  {
    meta: {
  ...
  },
  {
    ...
    title: "Match chat",
    summary: "",
    url: "/es/match-lobby/:matchId/chat",
    isHidden: true
  },
  {
    meta: {
    ...
    title: "Set Score Advantage",
    summary: "",
    url: "/es/match-lobby/:matchId/set-score-advantage",
    isHidden: true
  },
  {
    meta: {
    ...
    title: "Report Results",
    summary: "",
    url: "/es/match-lobby/:matchId/report-results",
    isHidden: true
  },
  {
    meta: {
  ...
  },
  {
    ...
    title: "Player credit",
    summary: "",
    url: "/es/all-players/:playerId/credit",
    isHidden: true
  },
  {
    meta: {
    ...
    title: "Player credit",
    summary: "",
    url: "/es/all-players/:playerId/credit-energy",
    isHidden: true
  },
  {
    meta: {
    ...
    title: "Player credit bonus",
    summary: "",
    url: "/es/all-players/:playerId/credit-bonus",
    isHidden: true
  },
  {
    meta: {
    ...
    title: "Player xp points",
    summary: "",
    url: "/es/all-players/:playerId/player-xp",
    isHidden: true
  },
  {
    meta: {
    ...
    title: "Player bonus transactions",
    summary: "",
    url: "/es/all-players/:playerId/bonus-transactions",
    isHidden: true
  },
  {
    meta: {
    ...
    title: "Player block",
    summary: "",
    url: "/es/all-players/:playerId/block",
    isHidden: true
  },
  {
    meta: {
    ...
    title: "Player withdraw",
    summary: "",
    url: "/es/all-players/:playerId/withdraw",
    isHidden: true
  },
  {
    meta: {
    ...
    title: "Player transactions",
    summary: "",
    url: "/es/all-players/:playerId/transactions",
    isHidden: true
  },
  {
    meta: {
    ...
    title: "Player matches",
    summary: "",
    url: "/es/all-players/:playerId/matches",
    isHidden: true
  },
  {
    meta: {
    ...
    title: "Player Boy Profile",
    summary: "",
    url: "/es/all-players/:playerId/boy-profile",
    isHidden: true
  },
  {
    meta: {
  ...
  },
  {
    ...
    title: "Bonus Transaction Details",
    summary: "",
    url: "/es/bonus-transaction-details/:transactionId/",
    isHidden: true
  },
  {
    meta: {
  ...
  },
  {
    ...
    title: "Create Bonus Campaign",
    summary: "",
    url: "/es/bonus-campaigns/new/create",
    isHidden: true
  },
  {
    meta: {
    ...
    title: "Bonus Campaign Details",
    summary: "",
    url: "/es/bonus-campaigns/:bonusId",
    isHidden: true
  },
  {
    meta: {
  ...
  },
  {
    ...
    title: "Affiliate Urls",
    summary: "",
    url: "/es/affiliates/:affiliateId/urls",
    isHidden: true
  },
  {
    meta: {
    ...
    title: "Create Affiliate Url",
    summary: "",
    url: "/es/affiliates/:affiliateId/urls/create",
    isHidden: true
  },
  {
    meta: {
    ...
    title: "AffiliateReporting",
    summary: "",
    url: "/es/affiliates/:affiliateId/affiliate-reporting",
    isHidden: true
  },
  {
    meta: {
    ...
    title: "UpdateAffiliate",
    summary: "",
    url: "/es/affiliates/:affiliateId/update",
    isHidden: true
  },
  {
    meta: {
    ...
    title: "Create Promotion",
    summary: "",
    url: "/es/promotions/create-promotion",
    isHidden: true
  },
  {
    meta: {
    ...
    title: "Update Promotion",
    summary: "",
    url: "/es/promotions/:promotionId/update-promotion",
  ...
  },
  {
    ...
    title: "Update Affiliate Url",
    summary: "",
    url: "/es/affiliates/:affiliateId/urls/:urlId/update",
    isHidden: true
  },
  {
    meta: {
    ...
    title: "Affiliate Promotions",
    summary: "",
    url: "/es/affiliates/:affiliateId/affiliate-promotions",
    isHidden: true
  },
  {
    meta: {
    ...
    title: "Promote Affiliate",
    summary: "",
    url: "/es/affiliates/:affiliateId/promote",
  ...
  },
  {
    ...
    title: "Tournaments",
    summary: "",
    url: "/es/game-lobby/:gameId/tournaments"
  },
  {
    meta: {
      title: "Matches",
  ...
  },
  {
    ...
    summary: "",
    url: "/es/admin-matches/matchmaking",
    isHidden: true
  },
  {
    meta: {
  ...
  },
  {
    ...
    title: "BOY Match Detail",
    summary: "",
    url: "/es/admin-boy-matches/:matchId/update-status"
  },
  {
    meta: {
      title: "IPs Report",
  ...
  },
  {
    ...
    title: "Update BOY Profile",
    summary: "",
    url: "/es/uplay/:gameId/update-boy-profile",
    isHidden: true
  },
  {
    meta: {
