...
export const jpPages = [
  ...
  },
  {
    ...
    title: "Recent Players",
    summary: "",
    url: "/jp/game-lobby/:gameId/recentplayers",
    isHidden: true
  },
  {
    meta: {
    ...
    title: "Matchmaking",
    summary: "",
    url: "/jp/game-lobby/:gameId/matchmaking",
    isHidden: true
  },
  {
    meta: {
    ...
    title: "Leaderboards",
    summary: "",
    url: "/jp/game-lobby/:gameId/leaderboards",
    isHidden: true
  },
  {
    meta: {
    ...
    title: "Leaderboards Details",
    summary: "",
    url: "/jp/game-lobby/:gameId/leaderboards/:playerId/:playerAction?",
    isHidden: true
  },
  {
    meta: {
  ...
  },
  {
    ...
    title: "Rules",
    summary: "",
    url: "/jp/game-lobby/:gameId/rules",
    isHidden: true
  },
  {
    meta: {
  ...
  },
  {
    ...
    title: "Player Details",
    summary: "",
    url: "/jp/player-details/:playerId",
    isHidden: true
  },
  {
    meta: {
    ...
    title: "Match Details",
    summary: "",
    url: "/jp/player-details/:playerId/matches/:matchId/:matchAction?",
    isHidden: true
  },
  {
    meta: {
    ...
    title: "Transaction Details",
    summary: "",
    url: "/jp/transaction-details/:transactionId/:transactionAction?",
    isHidden: true
  },
  {
    meta: {
    ...
    title: "Create Challenge",
    summary: "",
    url: "/jp/create-challenge/:gameId?",
    isHidden: true
  },
  {
    meta: {
    ...
    title: "Game details",
    summary: "",
    url: "/jp/admin-games/:gameId/:gameAction?",
    isHidden: true
  },
  {
    meta: {
    ...
    title: "Send Challenge Request",
    summary: "",
    url: "/jp/player-details/:playerId/send-challenge/:gameId?",
    isHidden: true
  },
  {
    meta: {
  ...
  },
  {
    ...
    title: "Match chat",
    summary: "",
    url: "/jp/match-lobby/:matchId/chat",
    isHidden: true
  },
  {
    meta: {
    ...
    title: "Set Score Advantage",
    summary: "",
    url: "/jp/match-lobby/:matchId/set-score-advantage",
    isHidden: true
  },
  {
    meta: {
    ...
    title: "Report Result",
    summary: "",
    url: "/jp/match-lobby/:matchId/report-results",
    isHidden: true
  },
  {
    meta: {
  ...
  },
  {
    ...
    title: "Player credit",
    summary: "",
    url: "/jp/all-players/:playerId/credit",
    isHidden: true
  },
  {
    meta: {
    ...
    title: "Player credit",
    summary: "",
    url: "/jp/all-players/:playerId/credit-energy",
    isHidden: true
  },
  {
    meta: {
    ...
    title: "Player credit bonus",
    summary: "",
    url: "/jp/all-players/:playerId/credit-bonus",
    isHidden: true
  },
  {
    meta: {
    ...
    title: "Player xp points",
    summary: "",
    url: "/jp/all-players/:playerId/player-xp",
    isHidden: true
  },
  {
    meta: {
    ...
    title: "Player bonus transactions",
    summary: "",
    url: "/jp/all-players/:playerId/bonus-transactions",
    isHidden: true
  },
  {
    meta: {
    ...
    title: "Player block",
    summary: "",
    url: "/jp/all-players/:playerId/block",
    isHidden: true
  },
  {
    meta: {
    ...
    title: "Player withdraw",
    summary: "",
    url: "/jp/all-players/:playerId/withdraw",
    isHidden: true
  },
  {
    meta: {
    ...
    title: "Player transactions",
    summary: "",
    url: "/jp/all-players/:playerId/transactions",
    isHidden: true
  },
  {
    meta: {
    ...
    title: "Player matches",
    summary: "",
    url: "/jp/all-players/:playerId/matches",
    isHidden: true
  },
  {
    meta: {
    ...
    title: "Player Boy Profile",
    summary: "",
    url: "/jp/all-players/:playerId/boy-profile",
    isHidden: true
  },
  {
    meta: {
  ...
  },
  {
    ...
    title: "Bonus Transaction Details",
    summary: "",
    url: "/jp/bonus-transaction-details/:transactionId/",
    isHidden: true
  },
  {
    meta: {
  ...
  },
  {
    ...
    title: "Create Bonus Campaign",
    summary: "",
    url: "/jp/bonus-campaigns/new/create",
    isHidden: true
  },
  {
    meta: {
    ...
    title: "Bonus Campaign Details",
    summary: "",
    url: "/jp/bonus-campaigns/:bonusId",
    isHidden: true
  },
  {
    meta: {
  ...
  },
  {
    ...
    title: "Affiliate Urls",
    summary: "",
    url: "/jp/affiliates/:affiliateId/urls",
    isHidden: true
  },
  {
    meta: {
    ...
    title: "Create Affiliate Url",
    summary: "",
    url: "/jp/affiliates/:affiliateId/urls/create",
    isHidden: true
  },
  {
    meta: {
    ...
    html: `<p>FE Boilerplate Malta can assist you to find the opportunity that you’re looking for or help you sustain your growth in business by finding excellent and suitable candidates for the opportunities you’re offering! Recruiting both from professional workers; from an administrator up to CEO level and also skilled workers. Should there’s a problem on the system please contact Emanuel on +356 20161010  or <a href="mailto:feboilerplate@incredible.com" target="_top">feboilerplate@incredible.com</a></p>`,
    template: "Affiliate Reporting",
    id: (id += 1),
    name: "Affiliate Reporting",
    title: "Affiliate Reporting",
    summary: "",
    url: "/jp/affiliates/:affiliateId/affiliate-reporting",
    isHidden: true
  },
  {
    meta: {
    ...
    title: "UpdateAffiliate",
    summary: "",
    url: "/jp/affiliates/:affiliateId/update",
    isHidden: true
  },
  {
    meta: {
    ...
    title: "Create Promotion",
    summary: "",
    url: "/jp/promotions/create-promotion",
    isHidden: true
  },
  {
    meta: {
    ...
    title: "Update Promotion",
    summary: "",
    url: "/jp/promotions/:promotionId/update-promotion",
  ...
  },
  {
    ...
    title: "Update Affiliate Url",
    summary: "",
    url: "/jp/affiliates/:affiliateId/urls/:urlId/update",
    isHidden: true
  },
  {
    meta: {
    ...
    title: "Affiliate Promotions",
    summary: "",
    url: "/jp/affiliates/:affiliateId/affiliate-promotions",
    isHidden: true
  },
  {
    meta: {
    ...
    title: "Promote Affiliate",
    summary: "",
    url: "/jp/affiliates/:affiliateId/promote",
  ...
  },
  {
    ...
    title: "Tournaments",
    summary: "",
    url: "/jp/game-lobby/:gameId/tournaments"
  },
  {
    meta: {
      title: "Matches",
  ...
  },
  {
    ...
    summary: "",
    url: "/jp/admin-matches/matchmaking",
    isHidden: true
  },
  {
    meta: {
  ...
  },
  {
    ...
    title: "BOY Match Detail",
    summary: "",
    url: "/jp/admin-boy-matches/:matchId/update-status"
  },
  {
    meta: {
      title: "IPs Report",
  ...
  },
  {
    ...
    title: "Update BOY Profile",
    summary: "",
    url: "/jp/uplay/:gameId/update-boy-profile",
    isHidden: true
  },
  {
    meta: {
