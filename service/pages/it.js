...
export const itPages = [
  ...
  },
  {
    ...
    html: "<p>You can view the data for your profile.</p>",
  ...
  },
  {
    ...
    html:
      "<p>It's all good, it happens to the best of us. Please input your email address and we will send you the necessary instructions to reset your password.</p>",
    template: "Forgot password",
    id: (id += 1),
    name: "Forgot password",
    title: "Forgot password",
    summary: "",
    url: `/it/forgot-password`,
    isHidden: true
  },
  {
    meta: {
    ...
    html: "<p>Please input your new password and you're good to go.</p>",
    template: "ResetPassword",
    id: (id += 1),
    name: "Reset Password",
    title: "Reset Password",
    summary: "",
    url: `/it/reset-password`,
    isHidden: true
  },
  {
    meta: {
  ...
  },
  {
    ...
    html: "<p>You can add a friend using his email address</p>",
    template: "Add Friend",
    id: (id += 1),
    name: "Add Friend",
    title: "Add Friend",
  ...
  },
  {
    ...
    title: "Recent Players",
    summary: "",
    url: "/it/game-lobby/:gameId/recentplayers",
    isHidden: true
  },
  {
    meta: {
    ...
    title: "Matchmaking",
    summary: "",
    url: "/it/game-lobby/:gameId/matchmaking",
    isHidden: true
  },
  {
    meta: {
    ...
    title: "Leaderboards",
    summary: "",
    url: "/it/game-lobby/:gameId/leaderboards",
    isHidden: true
  },
  {
    meta: {
    ...
    id: (id += 1),
    name: "Leaderboards Details",
    title: "Leaderboards Details",
    summary: "",
    url: "/it/game-lobby/:gameId/leaderboards/:playerId/:playerAction?",
    isHidden: true
  },
  {
    meta: {
  ...
  },
  {
    ...
    title: "Rules",
    summary: "",
    url: "/it/game-lobby/:gameId/rules",
    isHidden: true
  },
  {
    meta: {
  ...
  },
  {
    ...
    title: "Player Details",
    summary: "",
    url: "/it/player-details/:playerId",
    isHidden: true
  },
  {
    meta: {
    ...
    title: "Match Details",
    summary: "",
    url: "/it/player-details/:playerId/matches/:matchId/:matchAction?",
    isHidden: true
  },
  {
    meta: {
    ...
    title: "Transaction Details",
    summary: "",
    url: "/it/transaction-details/:transactionId/:transactionAction?",
    isHidden: true
  },
  {
    meta: {
    ...
    title: "Create Challenge",
    summary: "",
    url: "/it/create-challenge/:gameId?",
    isHidden: true
  },
  {
    meta: {
    ...
    title: "Game details",
    summary: "",
    url: "/it/admin-games/:gameId/:gameAction?",
    isHidden: true
  },
  {
    meta: {
    ...
    title: "Send Challenge Request",
    summary: "",
    url: "/it/player-details/:playerId/send-challenge/:gameId?",
    isHidden: true
  },
  {
    meta: {
  ...
  },
  {
    ...
    title: "Match chat",
    summary: "",
    url: "/it/match-lobby/:matchId/chat",
    isHidden: true
  },
  {
    meta: {
    ...
    title: "Set Score Advantage",
    summary: "",
    url: "/it/match-lobby/:matchId/set-score-advantage",
    isHidden: true
  },
  {
    meta: {
    ...
    title: "Report Results",
    summary: "",
    url: "/it/match-lobby/:matchId/report-results",
    isHidden: true
  },
  {
    meta: {
  ...
  },
  {
    ...
    title: "Player credit",
    summary: "",
    url: "/it/all-players/:playerId/credit",
    isHidden: true
  },
  {
    meta: {
    ...
    title: "Player credit",
    summary: "",
    url: "/it/all-players/:playerId/credit-energy",
    isHidden: true
  },
  {
    meta: {
    ...
    title: "Player credit bonus",
    summary: "",
    url: "/it/all-players/:playerId/credit-bonus",
    isHidden: true
  },
  {
    meta: {
    ...
    title: "Player xp points",
    summary: "",
    url: "/it/all-players/:playerId/player-xp",
    isHidden: true
  },
  {
    meta: {
    ...
    title: "Player bonus transactions",
    summary: "",
    url: "/it/all-players/:playerId/bonus-transactions",
    isHidden: true
  },
  {
    meta: {
    ...
    html: "Please submit the value you would like to transfer to the player. ",
    template: "Player block",
    id: (id += 1),
    name: "Player block",
    title: "Player block",
    summary: "",
    url: "/it/all-players/:playerId/block",
    isHidden: true
  },
  {
    meta: {
    ...
    title: "Player withdraw",
    summary: "",
    url: "/it/all-players/:playerId/withdraw",
    isHidden: true
  },
  {
    meta: {
    ...
    title: "Player transactions",
    summary: "",
    url: "/it/all-players/:playerId/transactions",
    isHidden: true
  },
  {
    meta: {
    ...
    title: "Player matches",
    summary: "",
    url: "/it/all-players/:playerId/matches",
    isHidden: true
  },
  {
    meta: {
    ...
    title: "Player Boy Profile",
    summary: "",
    url: "/it/all-players/:playerId/boy-profile",
    isHidden: true
  },
  {
    meta: {
  ...
  },
  {
    ...
    title: "Bonus Transaction Details",
    summary: "",
    url: "/it/bonus-transaction-details/:transactionId/",
    isHidden: true
  },
  {
    meta: {
  ...
  },
  {
    ...
    title: "Create Bonus Campaign",
    summary: "",
    url: "/it/bonus-campaigns/new/create",
    isHidden: true
  },
  {
    meta: {
    ...
    title: "Bonus Campaign Details",
    summary: "",
    url: "/it/bonus-campaigns/:bonusId",
    isHidden: true
  },
  {
    meta: {
  ...
  },
  {
    ...
    title: "Affiliate Urls",
    summary: "",
    url: "/en/affiliates/:affiliateId/urls",
    isHidden: true
  },
  {
    meta: {
    ...
    title: "Create Affiliate Url",
    summary: "",
    url: "/it/affiliates/:affiliateId/urls/create",
    isHidden: true
  },
  {
    meta: {
    ...
    html: `<p>FE Boilerplate Malta can assist you to find the opportunity that you’re looking for or help you sustain your growth in business by finding excellent and suitable candidates for the opportunities you’re offering! Recruiting both from professional workers; from an administrator up to CEO level and also skilled workers. Should there’s a problem on the system please contact Emanuel on +356 20161010  or <a href="mailto:feboilerplate@incredible.com" target="_top">feboilerplate@incredible.com</a></p>`,
    template: "AffiliateReporting",
    id: (id += 1),
    name: "AffiliateReporting",
    title: "AffiliateReporting",
    summary: "",
    url: "/it/affiliates/:affiliateId/affiliate-reporting",
    isHidden: true
  },
  {
    meta: {
    ...
    title: "UpdateAffiliate",
    summary: "",
    url: "/it/affiliates/:affiliateId/update",
    isHidden: true
  },
  {
    meta: {
    ...
    title: "Create Promotion",
    summary: "",
    url: "/it/promotions/create-promotion",
    isHidden: true
  },
  {
    meta: {
    ...
    title: "Update Promotion",
    summary: "",
    url: "/it/promotions/:promotionId/update-promotion",
  ...
  },
  {
    ...
    title: "Update Affiliate Url",
    summary: "",
    url: "/it/affiliates/:affiliateId/urls/:urlId/update",
    isHidden: true
  },
  {
    meta: {
    ...
    title: "Affiliate Promotions",
    summary: "",
    url: "/it/affiliates/:affiliateId/affiliate-promotions",
    isHidden: true
  },
  {
    meta: {
    ...
    title: "Promote Affiliate",
    summary: "",
    url: "/it/affiliates/:affiliateId/promote",
  ...
  },
  {
    ...
    title: "Tournaments",
    summary: "",
    url: "/it/game-lobby/:gameId/tournaments"
  },
  {
    meta: {
      title: "Matches",
  ...
  },
  {
    ...
    summary: "",
    url: "/it/admin-matches/matchmaking",
    isHidden: true
  },
  {
    meta: {
  ...
  },
  {
    ...
    title: "BOY Match Detail",
    summary: "",
    url: "/it/admin-boy-matches/:matchId/update-status"
  },
  {
    meta: {
      title: "IPs Report",
  ...
  },
  {
    ...
    title: "Update BOY Profile",
    summary: "",
    url: "/it/uplay/:gameId/update-boy-profile",
    isHidden: true
  },
  {
    meta: {
